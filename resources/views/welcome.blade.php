...
<body class="font-sans antialiased bg-gradient-to-br from-rose-50 via-white to-gray-50 min-h-screen">
    ...
    <div class="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div class="relative text-center max-w-5xl mx-auto">
            ...
            <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
                <div class="group bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 font-serif text-center">Customer Portal</h3>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed text-center flex-grow">Book services and manage appointments with our elegant booking system designed for your convenience</p>
                    <div class="text-center mt-auto">
                        <a href="{{ route('book-service') }}" 
                           class="inline-flex items-center text-rose-600 hover:text-rose-700 font-semibold group transition-colors duration-200">
                            Get Started
                ...
                <div class="group bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 font-serif text-center">Service Management</h3>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed text-center flex-grow">Comprehensive tools to manage salon services, pricing, and availability with ease</p>
                    <div class="text-center mt-auto">
                ...
                <div class="group bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 h-full flex flex-col">
                    <div class="w-16 h-16 bg-gradient-to-br from-gray-500 to-gray-600 rounded-xl flex items-center justify-center mb-6 mx-auto shadow-md">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 font-serif text-center">Admin Dashboard</h3>
                    <p class="text-base text-gray-600 mb-6 leading-relaxed text-center flex-grow">Complete administrative control with analytics and comprehensive management tools</p>
                    <div class="text-center mt-auto">
                        <a href="{{ route('admin.dashboard') }}" 
                           class="inline-flex items-center text-rose-600 hover:text-rose-700 font-semibold group transition-colors duration-200">
                            Admin Panel
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('book-service') }}" class="text-gray-900 hover:text-rose-400 transition-colors duration-200">Book Appointment</a></li>
                        <li><a href="{{ route('services') }}" class="text-gray-900 hover:text-rose-400 transition-colors duration-200">Our Services</a></li>
                        <li><a href="{{ route('admin.dashboard') }}" class="text-gray-900 hover:text-rose-400 transition-colors duration-200">Admin Portal</a></li>
                        <li><a href="{{ route('admin.services') }}" class="text-gray-900 hover:text-rose-400 transition-colors duration-200">Manage Services</a></li>
                        <li><a href="{{ route('contact') }}" class="text-gray-900 hover:text-rose-400 transition-colors duration-200">Contact Us</a></li>
                    </ul>
                </div>
