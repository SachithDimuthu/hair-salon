...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Create a new service for your salon</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.services.store') }}" method="POST" class="divide-y divide-gray-200">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" 
                                      ...
                                      placeholder="Detailed description of the service, what's included, benefits, etc.">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('requires_consultation') ? 'checked' : '' }}
